...
import { Box, HStack, ProgressCircle, Text, VStack } from "@chakra-ui/react";
...
export default function BarGraph() {
  return (
    <Box w="100%" h="100%" pb={4} pl={4}>
      <CustomCard>
        <VStack width="100%" height="100%" gap={4} textAlign="center">
          <Text justifyContent="center" alignItems="True">
            Hello
          </Text>
          <Demo />
        </VStack>
...
const Demo = () => {
  ...
  return (
    <Chart.Root h="100%" w="100%" chart={chart} mr={3}>
      <BarChart
        stackOffset="none"
        data={chart.data}
        maxBarSize={15}
